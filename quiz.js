...
function displayResult(score) {
    let badge = "Bronze";
    let badgeImageSrc = "Videos/Bronze.gif"; //  bronze badge image

    if (score >= 8) {
        badge = "Gold";
        badgeImageSrc = "Videos/gold.gif"; //  gold badge image
    } else if (score >= 4) {
        badge = "Silver";
        badgeImageSrc = "Videos/silver.gif"; // silver badge image
    }
